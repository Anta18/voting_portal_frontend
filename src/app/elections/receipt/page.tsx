        ...
        {receipt ? (
          <div className="p-6 rounded-lg bg-gray-700 shadow-lg">
            <div className="flex flex-col items-center mb-4">
              ...
              <p className="text-xl font-semibold text-green-400 mb-8">Vote Recorded Successfully!</p>
            </div>
          ...
          <p className="text-lg text-gray-300 text-center">No receipt information found.</p>
        )}
      </div>
    </div>
  );
